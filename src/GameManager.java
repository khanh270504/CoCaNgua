...
//        PlayerList[1].horseList.get(3).Move(55 - 6);
...
//    	System.out.println( PlayerList[currentPlayer].horseList.size());
    ...
    public void CheckPlayerCanMove(){
        boolean next = true;
//        
//        for (Iterator<Horse> iterator = PlayerList[currentPlayer].horseList.iterator(); iterator.hasNext();) {
//            Horse horse = iterator.next();
//            if (horse.isWin) {
//                iterator.remove();
//                if(PlayerList[currentPlayer].horseList.size() == 0 && dice.diceValue == 6) {
